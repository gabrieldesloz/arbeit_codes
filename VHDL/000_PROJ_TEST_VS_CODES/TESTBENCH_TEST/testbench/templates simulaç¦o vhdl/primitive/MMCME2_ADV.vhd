...
--  end if;
  ...
  if (BANDWIDTH = "LOW") then
    ...
    case clkfb_div_fint is
       ...
       when 13 => pll_cp := "1110"; pll_res := "0001";
       when 14 => pll_cp := "1111"; pll_res := "0001";
       when 15 => pll_cp := "1111"; pll_res := "0001";
       when 16 => pll_cp := "1111"; pll_res := "0001";
       when 17 => pll_cp := "1110"; pll_res := "0110";
       when 18 => pll_cp := "1111"; pll_res := "0110";
       when 19 => pll_cp := "1110"; pll_res := "1010";
       when 20 => pll_cp := "1110"; pll_res := "1010";
       when 21 => pll_cp := "1111"; pll_res := "1010";
       when 22 => pll_cp := "1111"; pll_res := "1010";
       when 23 => pll_cp := "1111"; pll_res := "1010";
       when 24 => pll_cp := "1111"; pll_res := "1010";
       when 25 => pll_cp := "0111"; pll_res := "0010";
       when 26 => pll_cp := "0111"; pll_res := "0010";
       when 27 => pll_cp := "1110"; pll_res := "1010";
       when 28 => pll_cp := "0110"; pll_res := "0010";
       when 29 => pll_cp := "0110"; pll_res := "0010";
       when 30 => pll_cp := "0110"; pll_res := "0010";
       when 31 => pll_cp := "0100"; pll_res := "0100";
       when 32 => pll_cp := "1101"; pll_res := "0110";
       when 33 => pll_cp := "1101"; pll_res := "0110";
       when 34 => pll_cp := "0101"; pll_res := "0010";
       when 35 => pll_cp := "0101"; pll_res := "0010";
       when 36 => pll_cp := "0101"; pll_res := "0010";
  ...
  begin
    if (rst_in = '1') then
       ...
       if (clkin_hold_f = 1) then
         ...
         assert FALSE  report " Error : input CLKIN1 of MMCME2_ADV is stopped. Reset is required for MMCME2_ADV whether stopped input clock comes back or not." severity error;
         else
         assert FALSE report " Error : input CLKIN2 of MMCME2_ADV  is stopped. Reset is required for MMCME2_ADV whether stopped input clock comes back or not." severity error;
         end if;
       end if;
    end if;
