...
--   08/06/10 - Remove CASCADE option for COMPENSATION (CR571190)
...
--   11/15/11 - Do DRC check for samples CLKIN period at lock time (CR632943)
...
--  end if;
  ...
  if (BANDWIDTH = "LOW") then
    ...
    case clkfb_div_fint is
       ...
       when 10 => pll_cp := "1111"; pll_res := "0011";
       when 11 => pll_cp := "1110"; pll_res := "0101";
       when 12 => pll_cp := "1111"; pll_res := "0101";
       when 13 => pll_cp := "1111"; pll_res := "1001";
       when 14 => pll_cp := "1101"; pll_res := "0001";
       when 15 => pll_cp := "1111"; pll_res := "1110";
       when 16 => pll_cp := "1110"; pll_res := "0001";
       when 17 => pll_cp := "1111"; pll_res := "0001";
       when 18 => pll_cp := "1111"; pll_res := "0001";
       when 19 => pll_cp := "1111"; pll_res := "0001";
       when 20 => pll_cp := "1110"; pll_res := "0110";
       when 21 => pll_cp := "1110"; pll_res := "0110";
       when 22 => pll_cp := "1111"; pll_res := "0110";
       when 23 => pll_cp := "1111"; pll_res := "0110";
       when 24 => pll_cp := "1110"; pll_res := "1010";
       when 25 => pll_cp := "1110"; pll_res := "1010";
       when 26 => pll_cp := "1110"; pll_res := "1010";
       when 27 => pll_cp := "1101"; pll_res := "1010";
       when 28 => pll_cp := "0110"; pll_res := "0010";
       when 29 => pll_cp := "0110"; pll_res := "0010";
       when 30 => pll_cp := "0110"; pll_res := "0010";
       when 31 => pll_cp := "1101"; pll_res := "0110";
       when 32 => pll_cp := "1100"; pll_res := "1010";
       when 33 => pll_cp := "0110"; pll_res := "1100";
       when 34 => pll_cp := "0110"; pll_res := "1100";
