...
entity edge_calculator_VARIABLE_CHECK is
  ...
  port (
    ...
    neg_edges  : out std_logic_vector(FREQ_BITS-1 downto 0);
    pos_edges  : out std_logic_vector(FREQ_BITS-1 downto 0);
    sysclk     : in  std_logic;
    n_reset    : in  std_logic;
    edge_calc  : out std_logic
    );

end entity edge_calculator_VARIABLE_CHECK;
...
architecture edge_calculator_RTL of edge_calculator is
  ...
  signal neg_edges_reg, pos_edges_reg   : std_logic_vector(FREQ_BITS-1 downto 0);
  signal neg_edges_next, pos_edges_next : std_logic_vector(FREQ_BITS-1 downto 0);
    ...
    case state_reg is
      ...
      when OP =>
        ...
        if start_stop = '0' then
          ...
          if pos_edges_reg = EDGE_TO_CHECK then            
          edge_calc_next <= '1';
          end if;
