...
xst -ifn xst.scr
copy clkblock_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\clkblock.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clkblock.ucf clkblock_exdes

echo 'Running map'
map -timing -pr b clkblock_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -tm clkblock_exdes -w routed.ncd routed.v
cd ..
