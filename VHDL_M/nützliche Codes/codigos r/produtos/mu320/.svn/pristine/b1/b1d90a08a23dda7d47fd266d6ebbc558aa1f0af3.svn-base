...
entity quality is
  ...
  port (
    ...
    data_in           : in  std_logic_vector((N_CHANNELS_ANA*N_BITS_ADC*2 - 1) downto 0);
    data_in_available : in  std_logic;
    data_out_ready    : out std_logic;
    data_out          : out std_logic_vector((N_CHANNELS_ANA*N_BITS_ADC*4 - 1) downto 0));
...
architecture quality_rtl of quality is
  ...
  signal data_in_reg             : std_logic_vector((N_CHANNELS_ANA*N_BITS_ADC*2 - 1) downto 0);
  signal data_in_reg_next        : std_logic_vector((N_CHANNELS_ANA*N_BITS_ADC*2 - 1) downto 0);
  signal data_out_reg            : std_logic_vector((N_CHANNELS_ANA*N_BITS_ADC*4 - 1) downto 0);
  signal data_out_reg_next       : std_logic_vector((N_CHANNELS_ANA*N_BITS_ADC*4 - 1) downto 0);
  signal data_out_ready_reg      : std_logic;
  signal data_out_ready_reg_next : std_logic;
  signal counter                 : std_logic_vector((N_CHANNELS_COUNTER_BITS - 1) downto 0);
  signal counter_next            : std_logic_vector((N_CHANNELS_COUNTER_BITS - 1) downto 0);
